...
\rowcolor{Gray}
 ...
 \rowcolor{Gray}
  &   &  -      &  +                     & +               & -                   & -                    &  - \\ \hline
THD 			& - 		& \cellcolor{lightgray}& ↓ & & & ↓ & ↓ \\ \hline
Output Power 	& + 	& \cellcolor{lightgray}& \cellcolor{lightgray}& ↑ & & ↓ & ↓ \\ \hline
$\eta$, Efficiency 		& + 	& \cellcolor{lightgray}& \cellcolor{lightgray}& \cellcolor{lightgray}& & ↑ & ↓ \\ \hline
Install Time		& - 		& \cellcolor{lightgray}& \cellcolor{lightgray}& \cellcolor{lightgray}& \cellcolor{lightgray}& ↓ & \\ \hline
Dimensions 		& - 		& \cellcolor{lightgray}& \cellcolor{lightgray}&\cellcolor{lightgray} & \cellcolor{lightgray}& \cellcolor{lightgray}& ↓ \\ \hline
Cost 			& - 		& \cellcolor{lightgray}& \cellcolor{lightgray}& \cellcolor{lightgray}& \cellcolor{lightgray}& \cellcolor{lightgray}& \cellcolor{lightgray} \\ \hline
\end{tabular}
\end{table}
...
\includegraphics[width=3in]{houseOfQuality}
\end{figure}
