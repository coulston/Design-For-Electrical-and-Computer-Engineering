...
\rowcolor{Gray}
 ...
 \rowcolor{Gray}
  &   &  -      &  +                     & +               & -                   & -                    &  - \\ \hline
THD 			& - 		& \cellcolor{black}& ↓ & & & ↓ & ↓ \\ \hline
Output Power 	& + 	& \cellcolor{black}& \cellcolor{black}& ↑ & & ↓ & ↓ \\ \hline
$\eta$, Efficiency 		& + 	& \cellcolor{black}& \cellcolor{black}& \cellcolor{black}& & ↑ & ↓ \\ \hline
Install Time		& - 		& \cellcolor{black}& \cellcolor{black}& \cellcolor{black}& \cellcolor{black}& ↓ & \\ \hline
Dimensions 		& - 		& \cellcolor{black}& \cellcolor{black}&\cellcolor{black} & \cellcolor{black}& \cellcolor{black}& ↓ \\ \hline
Cost 			& - 		& \cellcolor{black}& \cellcolor{black}& \cellcolor{black}& \cellcolor{black}& \cellcolor{black}& \cellcolor{black} \\ \hline
\end{tabular}
\end{table}
