...
\includegraphics[width=4.625in,height=1.71875in]{Fig/media/image1.emf}
...
\subsubsection{A Fifth Property --
...
\subsubsection{Identifying Engineering
...
\bottomrule\noalign{}
\endlastfoot
1, 2, 4 & \begin{minipage}[t]{\linewidth}\raggedright
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
...
\textbf{Table 3.3} System Requirements for a Gigabit Ethernet card
testing project.
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.3010}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1016}}@{}}
\toprule\noalign{}
\multicolumn{2}{@{}>{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.3904} + 2\tabcolsep}}{%
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.2793}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1030}}@{}}
\toprule\noalign{}
\multicolumn{2}{@{}>{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.3823} + 2\tabcolsep}}{%
\multirow{2}{=}{\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage}}} & \begin{minipage}[b]{\linewidth}\raggedright
THD
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
