...
%% Definitions used throughout the text for formatting
\include{preamble}

%% When displayed, the solutions have two arguments:
%%		#1 The type of problem
%%				R	Review
%%				A	Application
%%				P 	Project
%%		#2 The text of the solution
...
%% Do not display the solutions - main body of text
%\newenvironment{solution}[2]{}{}
