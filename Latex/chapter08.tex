...
\includegraphics[width=5.5in,height=1.77083in]{media/image1.jpeg}
...
\emph{event} (\includegraphics{media/image2.wmf}),while the \emph{event
...
\includegraphics{media/image3.wmf} is the i\textsuperscript{th} event in
a discrete event space, then the event space is given by the union

\includegraphics{media/image4.wmf}. (1)
...
\includegraphics{media/image5.wmf} (2)

\includegraphics{media/image6.wmf}. (3)
...
typically denoted as \includegraphics{media/image7.wmf}, where \emph{X}
...
\includegraphics{media/image8.wmf}. It is determined from the PDF as
follows

\includegraphics{media/image9.wmf}. (4)
...
\includegraphics[width=3.5in,height=1.53125in]{media/image10.emf}
...
\includegraphics{media/image11.wmf}. (5)
...
\includegraphics{media/image12.wmf}. That is determined from the
integral

\includegraphics{media/image13.wmf}. (6)
...
\includegraphics{media/image14.wmf}. (7)
...
are the mean (\includegraphics{media/image15.wmf}) and variance
(\includegraphics{media/image16.wmf}). They are found from the PDF as
follows

\includegraphics{media/image17.wmf} (8)

\includegraphics{media/image18.wmf}. (9)
...
\includegraphics{media/image20.wmf}. (10)
...
\includegraphics[width=2.92708in,height=1.36458in]{media/image21.emf}
...
\includegraphics{media/image22.wmf}, (11)

where \emph{a} and \emph{b} are selected to meet the demands of a
particular problem.

\includegraphics[width=3in,height=1.22917in]{media/image23.emf}
...
probability \includegraphics{media/image26.wmf}, which is found by
...
\includegraphics{media/image27.wmf}. (13)
...
number of hours, for example \includegraphics{media/image28.wmf}. After
...
\includegraphics[width=5.48958in,height=1.69792in]{media/image29.emf}
...
device, \includegraphics{media/image30.wmf}, is defined, where the
...
\includegraphics{media/image30.wmf}. The failure rate tells us the
average rate that a collection of identical devices will fail at a given
time \emph{t}, while \includegraphics{media/image30.wmf} is a PDF used
to determine the probability that a given device will fail within a
specified time period. A CDF for \includegraphics{media/image30.wmf} is
determined as

\includegraphics{media/image31.wmf}. (14)
...
\includegraphics{media/image32.wmf}. (15)
...
\includegraphics[width=2.76042in,height=1.5625in]{media/image33.emf}
...
\includegraphics{media/image36.wmf}. (17)

Equating (16) and (17) provides the desired relationship between the
three quantities

\includegraphics{media/image37.wmf}, (18)

that is fundamental in establishing the connection between \emph{R(t)}
and \emph{λ(t)}. However, the PDF \includegraphics{media/image30.wmf}
...
\includegraphics{media/image44.wmf}
...
\includegraphics{media/image45.wmf}. (24)

At this point the form of the PDF for
\includegraphics{media/image30.wmf} is not known, but it can be found
...
\includegraphics{media/image46.wmf}. (25)
...
\includegraphics{media/image30.wmf} via integration by parts to be

\includegraphics{media/image47.wmf}. (26)
...
(a) From (26) the MTTF = \includegraphics{media/image48.wmf}

= \ul{114 years}.

(b) From (23) the reliability at 114 years is

\includegraphics{media/image49.wmf}
...
\includegraphics{media/image30.wmf}were symmetric about its mean, but
...
\includegraphics{media/image51.wmf} = \ul{909 years}!
...
\includegraphics{media/image52.wmf}, to estimate the device failure rate
...
\includegraphics{media/image53.wmf}. \includegraphics{media/image54.wmf}
is the base failure rate that is directly read from a table,
\includegraphics{media/image55.wmf}is a temperature factor which is
computed from an exponential equation (be careful to use the junction
temperature as indicated in Appendix C),
\includegraphics{media/image56.wmf} is an application factor that
depends upon how the device will be used,
\includegraphics{media/image57.wmf} is a quality factor, and
\includegraphics{media/image58.wmf} is an environmental factor. The
...
the factor \includegraphics{media/image59.wmf} is based upon the
...
\includegraphics{media/image60.wmf} is 0, the BJT is off, no current
flows through any branches of the device, and the output voltage,
\includegraphics{media/image61.wmf}, is 5V. When the input is 5V (high)
the BJT goes into saturation due to the high base current (low
\includegraphics{media/image62.wmf}), producing a 50mA collector
...
\includegraphics[width=4.25in,height=1.73958in]{media/image63.emf}
...
\includegraphics{media/image64.wmf}

The base failure rate is given directly as
\includegraphics{media/image65.wmf}. \includegraphics{media/image55.wmf}
is the temperature factor and its value is determined from the
relationship

\includegraphics{media/image66.wmf}.

where \emph{T\textsubscript{J}} is the junction temperature. As
indicated in Appendix C, it is computed as

\includegraphics{media/image67.wmf}

The thermal resistance, \includegraphics{media/image68.wmf}, is read
from the 2N3904 datasheet (Appendix D) and will be examined in more
detail shortly. The temperature factor is

\includegraphics{media/image69.wmf}

\includegraphics{media/image70.wmf} is an application factor (switched
or linear amplification), and the value for the switched logic inverter
is \includegraphics{media/image71.wmf}.
\includegraphics{media/image72.wmf} is a power rating factor that is
...
\includegraphics{media/image74.wmf} is a stress factor that is computed
...
\includegraphics{media/image75.wmf} is 5V (when the device is off and no
current flows), while the maximum rated value of
\includegraphics{media/image76.wmf} from the 2N3904 datasheet is 40V.

\includegraphics{media/image77.wmf}

\includegraphics{media/image78.wmf} is the quality factor, and based
upon the fact that a JANTX part is used
\includegraphics{media/image79.wmf}. \includegraphics{media/image80.wmf}
...
\includegraphics{media/image82.wmf}

This allows estimation of the MTTF and requested reliability

\includegraphics{media/image83.wmf} = \ul{71,804 years.}
...
(\includegraphics{media/image85.wmf}) and the thermal resistance. This
relationship is

\includegraphics{media/image86.wmf}. (27)
...
\includegraphics{media/image87.wmf}, while in the case with a heat sink,
\includegraphics{media/image88.wmf}. In the case of the heat sink,
\includegraphics{media/image89.wmf} is replaced by the sum
\includegraphics{media/image90.wmf}, which has a lower combined thermal
resistance and greater ability to dissipate heat.

\includegraphics[width=2.09375in,height=1.29167in]{media/image91.emf}
\includegraphics[width=3.01042in,height=1.5625in]{media/image92.emf}
...
\includegraphics{media/image93.wmf}. (28)

\includegraphics[width=1.84375in,height=1.46875in]{media/image94.emf}
\includegraphics[width=1.83333in,height=1.47917in]{media/image95.emf}
...
temperature (\includegraphics{media/image96.wmf}). The datasheets also
...
\includegraphics{media/image97.wmf} . (29)
...
\includegraphics[width=3.36458in,height=2.09375in]{media/image98.emf}
...
operating at an ambient temperature \includegraphics{media/image99.wmf}
...
thermal resistance of \includegraphics{media/image100.wmf} and a maximum
...
\includegraphics{media/image102.wmf}are re-computed.

\includegraphics{media/image103.wmf}\includegraphics{media/image104.wmf}

With this new value, the value of \includegraphics{media/image105.wmf},
...
a series system composed of boxes \includegraphics{media/image106.wmf},
\includegraphics{media/image107.wmf}, ...,
\includegraphics{media/image108.wmf} that represent the components, or
the subsystems, of a larger system.

\includegraphics[width=3.20833in,height=0.44792in]{media/image109.emf}

\textbf{Figure 8.11} A series system consisting of components, or
subsystems \includegraphics{media/image106.wmf},
\includegraphics{media/image107.wmf}, \ldots,
\includegraphics{media/image108.wmf}.

To compute the overall reliability of a series system,
\includegraphics{media/image110.wmf}, it is assumed that the failure of
subsystems or components are independent events. The system is operable
only if subsystems \includegraphics{media/image106.wmf} and
\includegraphics{media/image107.wmf} \ldots{} and
\includegraphics{media/image108.wmf} are all simultaneously operating.
...
\includegraphics{media/image111.wmf}. (30)
...
\includegraphics{media/image112.wmf} decreases as the number of
...
\includegraphics{media/image113.wmf}. (31)

This leads to a series system failure rate and MTTF of

\includegraphics{media/image114.wmf}. (32)
...
\includegraphics{media/image115.wmf}

For the collector resistor, R\textsubscript{C}, the base failure rate is
computed as

\includegraphics{media/image116.wmf}

The \emph{S} term is the ratio of power dissipated to the maximum power
rating. The values \includegraphics{media/image117.wmf},
\includegraphics{media/image118.wmf}, and
\includegraphics{media/image119.wmf} are directly read from tables. Thus
the overall failure rate for the collector resistor is

\includegraphics{media/image120.wmf}\includegraphics{media/image121.wmf}.

The process for the base resistor, R\textsubscript{B}, is similar, and
results in

\includegraphics{media/image122.wmf}\includegraphics{media/image123.wmf}.

The total failure rate is given from (32) as

\includegraphics{media/image124.wmf}

\includegraphics{media/image125.wmf}
...
(b) The MTTF is given by \includegraphics{media/image126.wmf} which in
...
\includegraphics{media/image127.wmf},
\includegraphics{media/image107.wmf}, \ldots,
\includegraphics{media/image128.wmf}.

\includegraphics[width=1.51042in,height=2.03125in]{media/image129.emf}

\textbf{Figure 8.12} A parallel, or redundant, system consisting of
subsystems \includegraphics{media/image106.wmf},
\includegraphics{media/image130.wmf}, \ldots,
\includegraphics{media/image108.wmf}

In order to compute the reliability of a parallel system, note that a
parallel system functions correctly when
\includegraphics{media/image131.wmf} is functioning correctly, or
\includegraphics{media/image132.wmf} is functioning correctly, \ldots{}
or \includegraphics{media/image133.wmf} is functioning correctly. It
would be nice if it were possible to write an equation stating that
\includegraphics{media/image134.wmf}\emph{,} where + is the logical OR
...
will fail by time \emph{t}, \includegraphics{media/image135.wmf}, is
equal to the probability that subsystem
\includegraphics{media/image136.wmf} will fail and
\includegraphics{media/image137.wmf} will fail and \ldots{}
\includegraphics{media/image138.wmf} will fail. This probability is
expressed mathematically as

\includegraphics[width=2.77083in,height=0.33333in]{media/image139.wmf}.
(33)

The overall system reliability of the parallel system is found from this
as

\includegraphics{media/image140.wmf} . (34)

As more redundant components are added to a parallel system, additional
\includegraphics{media/image141.wmf} terms are introduced into the
...
failure rate of \includegraphics{media/image142.wmf}. How many disks
...
\includegraphics{media/image143.wmf}.
...
\includegraphics{media/image144.wmf},
\includegraphics{media/image145.wmf}, and
\includegraphics{media/image146.wmf}\textsubscript{,} whose reliability
is determined by application of (34) to be
\includegraphics{media/image147.wmf}. The result is then combined with
\includegraphics{media/image106.wmf} in series to give the overall
system reliability, \includegraphics{media/image148.wmf}. The chapter
concludes with Example 8.8 that addresses combination system
reliability.

\includegraphics[width=2.35417in,height=1.71875in]{media/image149.emf}
...
\includegraphics{media/image150.wmf}. Determine the reliability that
subsystems \includegraphics{media/image151.wmf} and
\includegraphics{media/image152.wmf} must have so that the overall
system reliability is greater than 95\%.

\includegraphics[width=2.78125in,height=1.08333in]{media/image153.emf}

\emph{\textbf{\ul{Solution:}}} The parallel systems can combined into
single systems whose reliabilities are

\includegraphics{media/image154.wmf}

They are combined in series to give the overall system reliability

\includegraphics{media/image155.wmf}.

Substituting values and assuming \includegraphics{media/image156.wmf}
gives
...
\includegraphics{media/image106.wmf} and
\includegraphics{media/image159.wmf} have somewhat low reliabilities
relative to the overall system goal, but the reliability of the parallel
combination of \includegraphics{media/image106.wmf} and
\includegraphics{media/image160.wmf} is 96\%. It requires a reliability
for systems 3 and 4 of \includegraphics{media/image161.wmf}\ul{90\%},
...
\item
  ...
  increasing. That is, \includegraphics{media/image162.wmf}. Show why
...
\item
  ...
  \includegraphics{media/image163.wmf}. (a) Determine the mean time to
...
\item
  ...
  years in production, \includegraphics{media/image164.wmf}, the power
...
\includegraphics[width=2.5in,height=1.51042in]{media/image165.emf}
...
\includegraphics[width=2.8125in,height=1.77083in]{media/image166.emf}
...
\item
  ...
  \includegraphics{media/image167.wmf} and
  \includegraphics{media/image168.wmf}. If the device is operated at an
...
\item
  ...
  requirement?
\item
  \includegraphics{media/image106.wmf} has a failure probability of 2\%
  and \includegraphics{media/image169.wmf} has a failure probability of
  3\%. \includegraphics{media/image170.wmf},
  \includegraphics{media/image171.wmf},
  \includegraphics{media/image172.wmf}, and
  \includegraphics{media/image173.wmf} are identical redundant systems.
  Determine the required reliability of the redundant systems necessary
  for the overall system to have a reliability of 94\%.
\end{enumerate}

\includegraphics[width=2.0625in,height=1.96875in]{media/image174.emf}
...
\begin{quote}
\includegraphics[width=4.1875in,height=2.48958in]{media/image175.emf}
\end{quote}
