\section{Problems}
\label{section:projectManagementProblems}
...
\begin{table}[h]
\begin{tabular}{|m{2.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|}  \hline
...
\begin{table}[h]
\begin{tabular}{|m{2.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|}  \hline
