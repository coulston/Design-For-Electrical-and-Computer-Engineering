\chapter{System Reliability}are 
...
Six-Sigma, and Robust Design. While othref{er chapters have addressed some
...
\begin{equation}
\label{equ:reliabilityAndFailure}
R(t) = 1 - F(t)
\end{equation}
...
Equating this result with Equation~\ref{equ:failureReliabilityLambda}
produces

\begin{equation}
\label{equ:cdfOfFinTermsOfR}
...
\begin{equation}
\label{equ:mttfVariableFailureRate}
...
\begin{example}{Human lifespan estimation.}
...
\emph{\textbf{derating}}. From Equation~\ref{equ:junctionTemperature}
...
\label{section:reliabilitySummary-and-further-reading}
