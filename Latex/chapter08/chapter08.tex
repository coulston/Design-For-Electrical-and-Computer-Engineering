...
\emph{event} (\includegraphics{Fig/media/image2.wmf}),while the
...
typically denoted as \includegraphics{Fig/media/image7.wmf}, where
...
are the mean (\includegraphics{Fig/media/image15.wmf}) and variance
...
probability \includegraphics{Fig/media/image26.wmf}, which is found by
