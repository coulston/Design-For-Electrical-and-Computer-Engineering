...
\section{Engineering Design Projects}\label{engineering-design-projects}
...
\section{Sources of Project Ideas}\label{sources-of-project-ideas}
...
\section{Project Feasibility and Selection
...
\hline
Selection Criteria & Weights & \multicolumn{3} {|c|} Alternatives \\
...
\section{Needs Identification}\label{needs-identification}
...
\addcontentsline{toc}{subsection}{\hfill\break
...
\subsection*{Figure 2.1 The difficulties of communicating with the
...
\addcontentsline{toc}{subsection}{Figure 2.1 The difficulties of
communicating with the customer. (Dilbert © United Feature Syndicate.
...
\subsection*{Step 2: Interpret the Raw Data in Terms of
Needs}\label{step-2-interpret-the-raw-data-in-terms-of-needs}
\addcontentsline{toc}{subsection}{Step 2: Interpret the Raw Data in
Terms of Needs}
...
\subsection*{Step 3: Organize Needs into a
Hierarchy}\label{step-3-organize-needs-into-a-hierarchy}
\addcontentsline{toc}{subsection}{Step 3: Organize Needs into a
Hierarchy}
...
process.}
\label{fig:audioPortable}
\end{figure}

\subsection*{Step 4: Determine the Relative Importance of the Needs}
\label{step-4-determine-the-relative-importance-of-the-needs}
\addcontentsline{toc}{subsection}{Step 4: Determine the Relative Importance of the Needs}
...
\subsection*{Step 5: Review the Outcomes and the
Process}\label{step-5-review-the-outcomes-and-the-process}
\addcontentsline{toc}{subsection}{Step 5: Review the Outcomes and the
Process}
...
\section{The Research Survey}\label{the-research-survey}
...
\section{\texorpdfstring{Project Application: The Problem Statement
...
\section{\texorpdfstring{Summary and Further Reading
