\section{Project Selection and Needs
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1716}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1716}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1716}}@{}}
\toprule\noalign{}
...
Weights
\end{minipage}} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.5147} + 4\tabcolsep}@{}}{%
\begin{minipage}[b]{\linewidth}\raggedright
Alternatives
\end{minipage}} \\
& & \begin{minipage}[b]{\linewidth}\raggedright
...
\subsection{Needs Identification}\label{needs-identification}
...
\includegraphics[width=5.5in,height=1.92708in]{Fig/media/image1.png}
...
\addcontentsline{toc}{subsubsection}{Figure 2.1 The difficulties of
...
\addcontentsline{toc}{subsubsection}{Step 2: Interpret the Raw Data in
Terms of Needs}
...
\addcontentsline{toc}{subsubsection}{Step 3: Organize Needs into a
Hierarchy}
...
\includegraphics[width=5.19792in,height=5.57292in]{Fig/media/image2.emf}
...
\addcontentsline{toc}{subsubsection}{Step 4: Determine the Relative
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2853}}
...
\addcontentsline{toc}{subsubsection}{Step 5: Review the Outcomes and the
Process}
...
\subsection{The Research Survey}\label{the-research-survey}
