...
\begin{figure}
\hspace{0.5cm}
\includegraphics[width=1.58in,height=2.2in]{./image3.png}
\hspace{0.1cm}
\includegraphics[width=1.59in,height=2.2in]{./image4.png}
\hspace{0.1cm}
\includegraphics[width=1.9in,height=2.2in]{./image5.png}
...
External searching was covered to a great extent in 
...
\rowcolor{Gray}
\multicolumn{2}{c}{}    &
\textbf{\makecell[l]{Option 1 \\(Reference)}}  &
\textbf{Option 2} &
\textbf{Option 3} &
