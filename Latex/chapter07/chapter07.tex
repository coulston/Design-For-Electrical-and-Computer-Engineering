...
\multicolumn{2}{l|}{\makecell{$\square$ white box \\  $\text{\rlap{$\checkmark$}}\square$  black box }} \\ \hline
...
\multicolumn{1}{l|}{\makecell{ $\text{\rlap{$\checkmark$}}\square$  white box \\ $\square$ black box }} \\ \hline
...
\multicolumn{2}{|l|} {\textbf{Description:}}&
\multicolumn{4}{l|} {
\makecell[l]{	The robot's center must stay within \\
			12 to 18 centimeters of the wall over \\
			90\% of the course, while traveling \\
			parallel to a wall over a 3 meter course.}} &

\multicolumn{1}{l|}{\textbf{Type:}} &  
\multicolumn{1}{l|}{\makecell{$\square$ white box \\  $\text{\rlap{$\checkmark$}}\square$  black box }} \\ \hline
...
{\rotatebox[origin=c]{-90}{ \textbf{Step}}} &
{\rotatebox[origin=c]{-90}{ \textbf{Action}}} &
{\rotatebox[origin=c]{-90}{ \textbf{Expected Result}}} &
{\rotatebox[origin=c]{-90}{ \textbf{Pass}}} &
{\rotatebox[origin=c]{-90}{\textbf{Fail}}} & 
{\rotatebox[origin=c]{-90}{\textbf{N/A}}} & 
\multicolumn{2}{l|} {\textbf{Comments}} \\  \hline
...
\multicolumn{2}{|l|} {\textbf{Description:}}&
\multicolumn{4}{|l|} {
\makecell[l]{	Checks interaction of DC motors on the \\
			magnetic compass.}} &
...
\multicolumn{6}{|l|} {
\makecell[l]{
		A wooden turn-table should be placed on top of the cardinal \\
		direction	map. This map should be aligned with a magnetic \\
		compass. There should be no metal present while the alignment \\
		is being performed. Next, the partially assembled robot should \\
		be placed on the turn-table. The MCU should be connected to \\
		a terminal to observe and record data.} }  \\ \hline

{\rotatebox[origin=c]{-90}{ \textbf{Step}}} &
{\rotatebox[origin=c]{-90}{ \textbf{Action}}} &
{\rotatebox[origin=c]{-90}{\makecell{\textbf{Expected} \\ \textbf{Result}}}} &
{\rotatebox[origin=c]{-90}{ \textbf{Pass}}} &
{\rotatebox[origin=c]{-90}{\textbf{Fail}}} & 
{\rotatebox[origin=c]{-90}{\textbf{N/A}}} & 
\multicolumn{2}{l|} {\textbf{Comments}} \\  \hline
...
\begin{tabular}{|m{1cm}|m{2cm}|m{3.2cm}|m{0.5cm}|m{0.5cm}|m{0.5cm}|m{1cm}|m{1cm}|}
...
\multicolumn{2}{|l|} {\textbf{Description:}}&
\multicolumn{4}{|l|} {
\makecell[l]{ 	Checks that the compass returns correct \\
			angular measurements to the MCU. Test \\
			program is in ./test/compass\_unit\_test\_1.c}} &
