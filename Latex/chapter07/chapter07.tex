...
\includegraphics[width=2.88542in,height=2.39583in]{Fig/media/image1.emf}
...
\includegraphics{Fig/media/image2.wmf}, to produce a linearly
proportional output signal, \includegraphics{Fig/media/image3.wmf}. The
rectangular boundary in the figure represents a black box view of the
system. In this view, the system power,
\includegraphics{Fig/media/image4.wmf}, and ground would be applied to
...
node voltages (\includegraphics{Fig/media/image5.wmf}) would be checked
...
\includegraphics[width=3.79167in,height=1.76042in]{Fig/media/image7.emf}
...
\addcontentsline{toc}{subsubsection}{Matrix Tests}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.2540}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.2273}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.0446}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.0446}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.0356}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1604}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\textbf{Time:}} & \\
& \textbf{Setup:} &
\multicolumn{6}{>{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.7664} + 10\tabcolsep}@{}}{%
...
\multirow{2}{=}{\textbf{V\textsubscript{T}}} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.4812} + 2\tabcolsep}}{%
\textbf{Expected output}} & \multirow{2}{=}{\textbf{Pass}} &
\multirow{2}{=}{\textbf{Fail}} & \multirow{2}{=}{\textbf{N/A}} &
\multirow{2}{=}{\textbf{Comments}} \\
...
~ &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.6773} + 4\tabcolsep}}{%
\textbf{Overall test result:}} & \textbf{~} & \textbf{~} & \textbf{~} &
~ \\
\end{longtable}

\subsubsection*{Step-by-Step Tests}\label{step-by-step-tests}
\addcontentsline{toc}{subsubsection}{Step-by-Step Tests}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.2014}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.3252}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.0319}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.0366}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.0275}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.0733}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.1282}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.1374}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
1.0} & \textbf{Time:} & \\
& \textbf{Setup:} &
\multicolumn{7}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.7600} + 12\tabcolsep}@{}}{%
Make sure that the system was reset sometime prior and is in state
\$0.00.} \\
\textbf{Step} & \textbf{Action} & \textbf{Expected Result} &
\textbf{Pass} & \textbf{Fail} & \textbf{N/A} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.3388} + 4\tabcolsep}@{}}{%
\textbf{Comments}} \\
...
~ &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.5266} + 2\tabcolsep}}{%
\textbf{Overall test result:}} & \textbf{~} & \textbf{~} & \textbf{~} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.3388} + 4\tabcolsep}@{}}{%
~} \\
\end{longtable}

\subsubsection*{\texorpdfstring{Automated Test Scripts
}{Automated Test Scripts }}\label{automated-test-scripts}
\addcontentsline{toc}{subsubsection}{Automated Test Scripts }
...
\addcontentsline{toc}{subsubsection}{Acceptance Testing}
...
\textbf{~} & \textbf{Hardware Ver:} &
\multicolumn{5}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.4945} + 8\tabcolsep}}{%
Robot 1.0} & \textbf{Time:} & \\
& \textbf{Setup:} &
\multicolumn{7}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.7600} + 12\tabcolsep}@{}}{%
Completed robot should be fully charged and placed on 3 meter test
track.} \\
\textbf{Step} & \textbf{Action} & \textbf{Expected Result} &
\textbf{Pass} & \textbf{Fail} & \textbf{N/A} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.3388} + 4\tabcolsep}@{}}{%
...
\addcontentsline{toc}{subsubsection}{Integration Testing}
...
\includegraphics[width=4.86458in,height=2.07292in]{Fig/media/image8.emf}
...
should be connected to a terminal to observe and record data.} \\
\textbf{Step} & \textbf{Action} & \textbf{Expected Result} &
\textbf{Pass} & \textbf{Fail} & \textbf{N/A} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.3388} + 4\tabcolsep}@{}}{%
\textbf{Comments}} \\
...
sample compass at a sufficient rate depending on speed. & & & &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.3388} + 4\tabcolsep}@{}}{%
} \\
...
\addcontentsline{toc}{subsubsection}{Unit Testing}
...
\textbf{Table 7.6} Matrix unit test for the digital compass.
...
\textbf{~} & \textbf{Hardware Ver:} &
\multicolumn{5}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.4945} + 8\tabcolsep}}{%
Compass Module - Geosensor version 2.3} & \textbf{Time:} & \\
& \textbf{Setup:} &
\multicolumn{7}{>{\raggedright\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.7600} + 12\tabcolsep}@{}}{%
