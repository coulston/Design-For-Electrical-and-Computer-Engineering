...
\label{table:baseFailureRate}
\begin{tabular}{l}
$\lambda_b = 0.0003 [(\frac{S}{0.3}^{3})+1] exp [\frac{T+273}{358}]$ for T=85$^{\circ}$C max rated \\ 
$\lambda_b = 0.0003 [(\frac{S}{0.3}^{3})+1] exp [\frac{T+273}{398}]$ for T=125$^{\circ}$C max rated \\ 
$\lambda_b = 0.0003 [(\frac{S}{0.3}^{3})+1] exp [\frac{T+273}{423}]$ for T=150$^{\circ}$C max rated \\ 
\end{tabular}
\end{table}
