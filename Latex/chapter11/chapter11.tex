...
\includegraphics[width=4.69792in,height=7.23958in]{Fig/media/image1.png}

\textbf{Figure 11.1} (a) Example of a US patent for a floating point
overflow and sign detection unit.

\includegraphics[width=4.70833in,height=7.26042in]{Fig/media/image2.png}

\textbf{Figure 11.1} (b) First page of the patent description.

\includegraphics[width=4.79167in,height=7.25in]{Fig/media/image3.png}
...
\includegraphics[width=5.5in,height=1.89583in]{Fig/media/image4.png}
...
\includegraphics[width=2.48958in,height=2.29167in]{Fig/media/image5.emf}
